...
Compiling the app and the vault from a git checkout: [Run from source](/developer/run-from-source/). Linux system libraries and WSL notes stay in [CONTRIBUTING.md](https://github.com/bitrealm-dev/message-vault/blob/main/CONTRIBUTING.md).

## Next

Sign in with **http://localhost:8080** and your vault username and password, then [Import from a backup](/import-from-a-backup/).
