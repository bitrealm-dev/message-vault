...
A release-shaped Docker image from this checkout is on [Operator Docker](/vault/developer/docker-compose/). Trying the published image without compiling is on [Try the vault](/vault/user/get-started/try-the-vault/).
