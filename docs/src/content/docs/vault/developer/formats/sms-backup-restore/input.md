...
This reference describes the SMS and MMS XML structures consumed and preserved by the importer. It is not a replacement for SyncTech’s complete schema. Import behavior is documented in [import mapping](/vault/developer/formats/sms-backup-restore/mapping/).
