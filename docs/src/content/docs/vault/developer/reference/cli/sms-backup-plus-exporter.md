...
Limited rescue import in the desktop app. Attachment→message pairing in archives is heuristic. EML layouts: [FORMAT.md](/vault/developer/formats/sms-backup-plus/format/). Field mapping: [IMPORT_MAPPING.md](/vault/developer/formats/sms-backup-plus/mapping/).
