...
Limited rescue import in the desktop app. Field mapping and skip counters: [IMPORT_MAPPING.md](/vault/developer/formats/go-sms-pro/mapping/).

## SEE ALSO

- [GO SMS Pro user guide](/vault/user/how-to/rescue-imports/)
