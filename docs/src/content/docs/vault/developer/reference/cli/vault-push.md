...
| `--force` | | Force reprocessing: ignore the local journal and send again (append + server dedupe; does not wipe the vault). See [Import from a backup](/vault/user/import-from-a-backup/) and [Extract to files](/vault/user/how-to/extract-to-files/). |
...
The desktop app **Import** screen, or [Import from a backup](/vault/user/import-from-a-backup/) and [Extract to files](/vault/user/how-to/extract-to-files/).
