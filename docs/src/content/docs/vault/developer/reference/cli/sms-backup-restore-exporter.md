...
Input XML reference: [INPUT_FORMAT.md](/vault/developer/formats/sms-backup-restore/input/). Source → common-message mapping: [IMPORT_MAPPING.md](/vault/developer/formats/sms-backup-restore/mapping/).
