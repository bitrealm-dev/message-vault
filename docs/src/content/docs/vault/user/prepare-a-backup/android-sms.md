...
Open **Import**, set the source to **SMS Backup & Restore**, enter the owner phone numbers, and point at the XML file or folder. See [Import from a backup](/vault/user/import-from-a-backup/).
