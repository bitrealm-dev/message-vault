...
| **Trash** | Soft-deleted items ([Trash](/vault/user/how-to/trash/)) |
...
The tutorial ends here. The [How do I…](/vault/user/how-to/search/) pages cover search, contacts, convert, extract to files, and settings.
