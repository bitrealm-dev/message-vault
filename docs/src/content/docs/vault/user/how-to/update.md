...
The Docker tag `latest` points at the most recent release. For a specific version, use `bitrealm/message-vault:0.7.3` (no `v` prefix) or a tag from [Releases](https://github.com/bitrealm-io/message-vault/releases).
