...
The Docker tag `latest` points at the most recent release. For a specific version, use `bitrealm/message-vault:0.8.0` (no `v` prefix) or a tag from [Releases](https://github.com/bitrealm-io/message-vault/releases).
