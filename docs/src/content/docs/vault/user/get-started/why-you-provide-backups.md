...
[Try the vault](/vault/user/get-started/try-the-vault/) first if you have not seen the product yet. When you are ready for your own data, [prepare a backup](/vault/user/prepare-a-backup/).
