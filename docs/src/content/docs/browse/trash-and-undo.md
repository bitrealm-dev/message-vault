...
For day-to-day browsing, use **Conversations** and **Contacts**. To remove all message content for an account, use **Settings → Account** danger-zone actions (delete messages), which are wired to the live account APIs.
