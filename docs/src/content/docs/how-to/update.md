...
The Docker tag `latest` points at the most recent release. For a specific version, use `mbeisser1/message-vault:v0.3.0` or a tag from [Releases](https://github.com/bitrealm-dev/message-vault/releases).
