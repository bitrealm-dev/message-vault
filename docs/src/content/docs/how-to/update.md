...
The Docker tag `latest` points at the most recent release. For a specific version, use `bitrealm/message-vault:v0.7.1` or a tag from [Releases](https://github.com/bitrealm-dev/message-vault/releases).
