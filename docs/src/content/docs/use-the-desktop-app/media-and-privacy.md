...
description: Choose how attachments are handled and whether to replace personal information before sharing.
---

Choose your attachment and privacy settings before starting an export or format conversion.
...
| **Do not copy** | Leaves media out. Only message text is exported. |
