...
This starts the vault in demo mode with sample conversations ready to browse. The `message-vault-data` volume keeps the database between restarts.

## Browse the demo

Open **http://localhost:3000** and sign in with username `demo` and an empty password. You will find sample conversations to search, browse, and explore.

## Connect the desktop app

1. Open the desktop app on your computer.
2. Enter the vault address **http://localhost:8080** and connect.
