...
End-user install docs still warn about SmartScreen / Gatekeeper until signing is turned on. After the first signed release, update those warnings in [`install-the-desktop-app.md`](../src/content/docs/user/get-started/install-the-desktop-app.md) and the workflow release notes.
