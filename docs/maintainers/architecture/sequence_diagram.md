# Sequence diagrams — developer workflow

Published copy: [Vault Design](https://bitrealm.io/vault/developer/vault-design/). Edit this file and copy the Mermaid blocks onto that page in the same change.
