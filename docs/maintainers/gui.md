...
exporter. See [What’s inside an export](../src/content/docs/vault/developer/reference/export-structure.md)
...
exporter builds the [shared conversation structure](../src/content/docs/vault/developer/reference/export-structure.md),
...
End-user walkthrough: [Extract to files](../src/content/docs/vault/user/how-to/extract-to-files.md).
