...
export default function Settings() {
  ...
  return (
    <div style={{ padding: "1.5rem", maxWidth: "700px" }}>
      ...
      <h3 style={{ margin: "1.5rem 0 0.75rem", fontSize: "1rem", color: "var(--text)" }}>
        Defaults
      </h3>
      ...
      <div style={{ marginTop: "1.5rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
        <Button variant="primary" onClick={handleSave} style={{ padding: "0.5rem 1.5rem" }}>
          Save
        </Button>
        {saved && (
          <span style={{ fontSize: "0.875rem", color: "var(--ok)" }}>
            Saved to export.ini
          </span>
        )}
      </div>
