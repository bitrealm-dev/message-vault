...
#   ./scripts/lint-all.sh
#
# Stops on the first failure. Clippy covers the workspace and src-tauri. Biome lints web/; recommended rules are
...
#
# Skips docs/ and web-next/ (not the product path).
