...
| `--asset-upload-workers N` | | Simultaneous attachment uploads (default 12). Use `1` to disable parallel uploads. Message imports always remain sequential. Conversations also prepare (hash/upload) a few files ahead on background workers. |
