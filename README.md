...
<h1 align="center">Message Vault</h1>
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://bitrealm.dev/vault/user/"><strong>Explore the docs »</strong></a>
    <br />
...
Follow the [User Guide](https://bitrealm.dev/vault/user/get-started/what-is-message-vault/) to run the demo and import your own data.

See the [Developer Guide](https://bitrealm.dev/vault/developer/) to setup a local development environment and and compile and run from source.
...
- [Developer Guide](https://bitrealm.dev/vault/developer/)
